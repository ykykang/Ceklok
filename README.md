...
|---|---|---|
| Main popup | <img src="preview/2.png" alt="Main popup" width="200" /> | Log today's status, track progress, and see the full month at a glance. |
| Settings | <img src="preview/1.png" alt="Settings" width="200" /> | Adjust your monthly office target. |
